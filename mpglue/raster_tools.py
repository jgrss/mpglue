...
class QAMasker(object):
    ...
    def _set_dicts(self):
        ...
        self.landsat_qa_values = {'L-C1': {'fill': 1,
                                           'clear': [66, 130],
                                           'water': [68, 132],
                                           'shadow': [72, 136],
                                           'cloud': [96, 112, 160, 176, 224],
                                           'med-cloud': [130, 132, 136, 144, 160, 176]},
                                  'L8-C1': {'fill': 1,
                                            'clear': [322, 386, 834, 898, 1346],
                                            'water': [324, 388, 836, 900, 1348],
                                            'shadow': [328, 392, 840, 904, 1350],
                                            'snowice': [336, 368, 400, 432, 848, 880, 912, 944, 1352],
                                            'cloud': [352, 368, 416, 432, 480, 864, 880, 928, 944, 992],
                                            'med-cloud': [386, 388, 392, 400, 416, 432, 900, 904, 928, 944,
                                                          834, 836, 840, 848, 864, 880, 898, 912, 992]}}
